...
| Document | Use when |
| --- | --- |
| [county-config.md](./county-config.md) | Multi-county app model: `CountyConfig` features vs gap chrome vs runtime field presence; county search gate; app JSON loader modules (Phase 10); how to add a county without copying Arapahoe |
