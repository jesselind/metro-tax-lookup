...
| Layer | Where | Role |
| --- | --- | --- |
| TypeScript typecheck | `npm run typecheck` | `tsc --noEmit` on app + tests (`*.test.ts` included in `tsconfig.json`) |
