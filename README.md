...
| `supporting-data/douglas/` | Douglas County Assessor published text dumps + tax-district mill PDF (Phase 8 **Go**; Phase 9/9b ingest on branch; **Phase 9c** parcel-record next; not production-live until 9c). See **`docs/county-build-inputs.md`** and **`docs/county-ingest.md`** (Douglas JSON on disk). |
