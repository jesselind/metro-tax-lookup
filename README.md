...
- **Account type tile:** First summary tile labels **Real property** vs **Business personal property**. When several PINs share the situs, the whole tile is the switch control (swap icon decorative; **Account type** glossary stays independently clickable), matching the limited-comps full-tile pattern without the red alert chrome.
