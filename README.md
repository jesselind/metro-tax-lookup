...
4. Rebuild metro levy JSON (year-specific script):
   ...
   - Bill-impact callout ("A metro district rate on your bill changed since last year.") when any matched metro has a published purpose change; amber, not red/green. No whole-bill up/down dollars until priors cover more of the stack. Dollar detail stays in tile modals. Click scrolls to (and focuses) the first Changed levy tile.
