...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "LevyLineDistrictDetailDialog requires resident countyId; mills-history chart uses countyFeatureAvailable(\"millsHistory\", countyConfig) for that county (no omitted-id Arapahoe default).",
