...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "/sources: Arapahoe contact methodology names shipping counties; Douglas methodology notes Contact only when the stack has an LG ID and that gaps stay honest.",
    ],
  },
  {
    version: "5.4.0",
