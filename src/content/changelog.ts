...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Sky Ranch Metro District No. 3 (4571) reads chronologically: November 2020 elector authorization, then the August 2022 capital pledge to the community authority board, with approval evidence on each step instead of a trailing duplicate.",
